...
def find_monthly_clicks(row: pd.Series, conv_row: pd.Series, daily_total_clicks: float = 0) -> Tuple[Dict[str, int], float]:
    ...
    click_params = [
        ...
        ((0, 100), 15000, 4.5, 0.02),
        ((100, 500), 12900, 4.2, 0.02),
        ((500, 1000), 10800, 4.0, 0.02),
        ((1000, 5000), 7800, 3.8, 0.025),
        ((5000, 20000), 5400, 3.6, 0.025),
        ((20000, 50000), 3900, 3.2, 0.025),
        ((50000, 100000), 2400, 2.7, 0.025),
        ((100000, 200000), 1800, 2.3, 0.025),
        ((200000, 300000), 1500, 1.8, 0.025),
        ((300000, float('inf')), 1500, 1, 0.025)
    ]
