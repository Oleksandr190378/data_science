...
def get_daily_data(
    ...
    для списку пошукових термінів за вказаний місяць.
    
    Фокусується тільки на id_amz_search_term, total_clicks, total_orders
    для розрахунку сумарних значень за місяць.
    
    Якщо для термінів немає даних за деякі дні місяця, 
    ...
    :return: DataFrame з агрегованими даними за місяць
    """
    ...
    # Формуємо список всіх дат у цьому місяці
    ...
    for term in search_terms:
        ...
        # Перевіряємо, чи є дані за всі дні місяця
...
def get_monthly_seasonal_factor(start_date, end_date):
    """
    Розраховує середній сезонний фактор для місяця.
    
    :param start_date: початкова дата місяця
    :param end_date: кінцева дата місяця
    ...
    # Розраховуємо сезонний фактор для кожного дня місяця
