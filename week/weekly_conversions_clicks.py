...
def find_weekly_clicks(row: pd.Series, conv_row: pd.Series, daily_total_clicks: float = 0) -> Tuple[Dict[str, int], float]:
    ...
    click_params = [
        ...
        ((0, 100), 3500, 4.5, 0.02),
        ((100, 500), 3010, 4.2, 0.02),
        ((500, 1000), 2520, 4, 0.02),
        ((1000, 5000), 1820, 3.8, 0.025),
        ((5000, 20000), 1260, 3.6, 0.025),
        ((20000, 50000), 910, 3.1, 0.025),
        ((50000, 100000), 560, 2.6, 0.025),
        ((100000, 200000), 420, 2.0, 0.025),
        ((200000, 300000), 320, 1.6, 0.025)
        ((300000, float('inf')), 220, 1, 0.025)
    ]
