...
def find_clicks(row: pd.Series, conv_row: pd.Series, prev_avg_clicks: float = 1) -> Tuple[Dict[str, int], float]:
    ...
    click_params = [
        ...
        ((0, 100), 600, 4.5, 0.02),
        ((100, 500), 530, 4.2, 0.02),
        ((500, 1000), 460, 4, 0.02),
        ((1000, 5000), 360, 3.8, 0.025),
        ((5000, 20000), 280, 3.6, 0.025),
        ((20000, 50000), 190, 3.1, 0.025),
        ((50000, 100000), 120, 2.5, 0.025),
        ((100000, 200000), 80, 1.7, 0.025),
        ((200000, 300000), 60, 1.3, 0.025),
        ((300000, float('inf')), 60, 1, 0.025)
    ]
